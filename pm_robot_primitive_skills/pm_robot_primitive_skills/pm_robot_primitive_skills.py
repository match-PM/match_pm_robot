...
class PrimitiveSkillsNode(Node):
    ...
    def __init__(self):
        ...
        # i had to comment this out as there is a problem with the service type. maybe there is an issue with the unity services?? python cant find the services here
