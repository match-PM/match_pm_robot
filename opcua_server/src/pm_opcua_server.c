...
#ifdef UA_ENABLE_NODESET_COMPILER_DESCRIPTIONS
    attr.description =
        UA_LOCALIZEDTEXT("", "Sets the command to move the cylinder to its backward position.");
#endif
    retVal |= UA_Server_addNode_begin(
        server,
        UA_NODECLASS_VARIABLE,
...
#ifdef UA_ENABLE_NODESET_COMPILER_DESCRIPTIONS
    attr.description =
        UA_LOCALIZEDTEXT("", "Sets the command to move the cylinder to its forward position.");
#endif
    retVal |= UA_Server_addNode_begin(
        server,
        UA_NODECLASS_VARIABLE,
...
#ifdef UA_ENABLE_NODESET_COMPILER_DESCRIPTIONS
    attr.description =
        UA_LOCALIZEDTEXT("", "Whether or not the cylinder is set to its forward position.");
#endif
    retVal |= UA_Server_addNode_begin(
        server,
        UA_NODECLASS_VARIABLE,
