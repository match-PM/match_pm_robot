...
if((retVal = function_pm_opcua_server_194_begin(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_195_begin(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_196_begin(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_197_begin(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_198_begin(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_199_begin(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_200_begin(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_201_begin(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_202_begin(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_203_begin(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_204_begin(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_205_begin(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_206_begin(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_207_begin(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
...
if((retVal = function_pm_opcua_server_207_finish(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_206_finish(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_205_finish(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_204_finish(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_203_finish(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_202_finish(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_201_finish(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_200_finish(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_199_finish(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_198_finish(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_197_finish(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_196_finish(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_195_finish(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
if((retVal = function_pm_opcua_server_194_finish(server, ns)) != UA_STATUSCODE_GOOD) return retVal;
