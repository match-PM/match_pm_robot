...
### Action Client to send positions to the pm_joint_trajectory_action_server
...
class SendTargetsToJTC(Node):
    def __init__(self):
        ...
        self._action_client = ActionClient(
            self, ForwardCommand, "trajectory_target", callback_group=self.group1
        )
        ...
        self.timer = self.create_timer(
            wait_sec_between_publish, self.timer_callback, callback_group=self.group2
        )
