...
CallbackReturn PMSystem::on_configure(const State &previous_state)
{
    ...
    {
        RCLCPP_ERROR(rclcpp::get_logger("PMSystem"), "Failed to connect to OPCUA server.");
...
std::vector<CommandInterface> PMSystem::export_command_interfaces()
{
    ...
    command_interfaces.emplace_back(CommandInterface(
        "X_Axis_Joint/velocity",
        hardware_interface::HW_IF_VELOCITY,
        &m_x_axis.velocity
    ));
    command_interfaces.emplace_back(CommandInterface(
        "X_Axis_Joint/acceleration",
    ...
    command_interfaces.emplace_back(CommandInterface(
        "Y_Axis_Joint/velocity",
        hardware_interface::HW_IF_VELOCITY,
        &m_y_axis.velocity
    ));
    command_interfaces.emplace_back(CommandInterface(
        "Y_Axis_Joint/acceleration",
        hardware_interface::HW_IF_ACCELERATION,
    ...
    command_interfaces.emplace_back(CommandInterface(
        "Z_Axis_Joint/velocity",
        hardware_interface::HW_IF_VELOCITY,
        &m_z_axis.velocity
    ));
    command_interfaces.emplace_back(CommandInterface(
        "Z_Axis_Joint/acceleration",
        hardware_interface::HW_IF_ACCELERATION,
    ...
    command_interfaces.emplace_back(CommandInterface(
        "T_Axis_Joint/velocity",
        hardware_interface::HW_IF_VELOCITY,
        &m_t_axis.velocity
    ));
    command_interfaces.emplace_back(CommandInterface(
        "T_Axis_Joint/acceleration",
        hardware_interface::HW_IF_ACCELERATION,
